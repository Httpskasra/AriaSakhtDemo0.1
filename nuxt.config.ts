  ...
  hooks: {
    "pages:extend"(pages) {
      const legacyPanelMeta: Record<string, Record<string, unknown>> = {
        ...
        "/dashboard/companies": { layout: "panel", middleware: ["auth", "permission"], permission: { resource: "companies", action: "u" } },
        "/dashboard/admin/vendor-requests": { layout: "panel", middleware: ["auth", "permission"], permission: { resource: "companies", action: "u" } },
