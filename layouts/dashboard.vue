...
// فرضی: پرمیشن‌ها و اطلاعات کاربر را از استور یا API بگیرید
</script>
...
@media (max-width: 1023px) {
  ...
  .drawer-toggle { display: grid; place-items: center; position: fixed; top: 5.5rem; inset-inline-end: 1rem; z-index: 55; width: 2.5rem; height: 2.5rem; border: 0; border-radius: var(--radius-card); background: #fff; color: var(--blue-dark); box-shadow: var(--shadow-raised); }
}
</style>
