...
const socialLinks = [
  { label: 'اینستاگرام', href: 'https://www.instagram.com/', icon: 'i-lucide-instagram' },
  { label: 'تلگرام', href: 'https://t.me/', icon: 'i-lucide-send' },
  { label: 'لینکداین', href: 'https://www.linkedin.com/', icon: 'i-lucide-linkedin' },
